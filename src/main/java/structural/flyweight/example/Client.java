...
public class Client {
    public static void main(String[] args) {
        ...
        UnsharedConcreteFlyweight unsharedFlyweight1 = new UnsharedConcreteFlyweight(new AllState("AllState1"));
        UnsharedConcreteFlyweight unsharedFlyweight2 = new UnsharedConcreteFlyweight(new AllState("AllState2"));
